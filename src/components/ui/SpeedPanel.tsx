...
export function SpeedPanel({
  ...
  return (
    <div className={`bg-white/90 backdrop-blur-sm rounded-lg shadow-md flex items-center ${compact ? 'px-3 py-1.5 gap-3' : 'px-4 py-2 gap-4'} text-sm`}>
      {kmh !== null ? (
        <div className="flex items-baseline gap-1">
          <span className={`${compact ? 'text-xl' : 'text-2xl'} font-bold text-gray-800`}>{kmh}</span>
