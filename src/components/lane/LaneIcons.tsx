...
const iconPaths: Record<string, string> = {
  ...
  slight_left: `${circle}<g transform="rotate(-22 50 50)"><path d="M50 72 V26" fill="none" stroke="${stroke}" stroke-width="7" stroke-linecap="round"/><path d="M38 38 L50 26 L62 38" fill="none" stroke="${stroke}" stroke-width="7" stroke-linecap="round" stroke-linejoin="round"/></g>`,
  slight_right: `${circle}<g transform="rotate(22 50 50)"><path d="M50 72 V26" fill="none" stroke="${stroke}" stroke-width="7" stroke-linecap="round"/><path d="M38 38 L50 26 L62 38" fill="none" stroke="${stroke}" stroke-width="7" stroke-linecap="round" stroke-linejoin="round"/></g>`,
